...
GPIO.output(25,0) # Encender pin 25 para activar lampara
...
while True:
  ...
  #Enviar request a ThingSpeak (MATLAB), debe proveerse API de escritura y campo
  f=urllib.request.urlopen('http://api.thingspeak.com/update?api_key=GCQSEP5LQ13BNIAQ&field1='+tempu)
  f.read()
  time.sleep(5) #retraso de 8 segundo    
