...
Regarding server maintenance, other cheaper options can be taken into account in order to reduce the costs. For instance, there are some Virtual Private Servers (VPS) with lower costs as USD 150 by six months. As for the cost of each node, it depends on the hardware devices available.
...
- Upgrade of sensors from HC1008 towards TMP102 in the nodes (September 2021-December 2021).
